...
const ProductModal = ({ isOpen, onClose, onSave, product }) => {
    ...
    return (
        ...
        backdrop-blur-sm p-4 animate-in fade-in duration-300">
            ...
            animate-in zoom-in-95 duration-300">
                <div className="flex justify-between items-center p-6 border-b border-slate-100
                 bg-slate-50/50">
                    ...
                    <button onClick={onClose} className="p-2 bg-white text-slate-400
                     hover:text-slate-600 hover:bg-slate-100 rounded-full transition-all">
                        <X className="w-5 h-5" />
                    </button>
                </div>
